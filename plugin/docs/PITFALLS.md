...
| 21 | Service role key in frontend bundle — secret scan blocks deploy | CRITICAL | [SKILL.md](../skills/boa/SKILL.md) |
| 22 | Source maps in production — exposes original source to attackers | HIGH | [SKILL.md](../skills/boa/SKILL.md) |
| 23 | CSP `unsafe-inline` for scripts — weakens XSS protection | MEDIUM | [SKILL.md](../skills/boa/SKILL.md) |
| **Storage** | | | |
