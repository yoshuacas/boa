...
/**
 * Map a PostgreSQL type string to a JSON Schema type descriptor.
 * Handles both short names (e.g. "text") and full pg_catalog
 * format_type() output (e.g. "character varying").
 */
...
export function generateSpec(schema, apiUrl) {
  ...
  return {
    openapi: '3.0.3',
    info: {
      title: 'BOA PostgREST-Compatible API',
      version: '1.0.0',
    },
    servers: [{ url: apiUrl }],
    paths,
